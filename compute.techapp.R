compute.techapp= function(case, tech, lshowplot=FALSE){
  ...
  pdf(file=paste("/Users/dorotheespuhler/Dropbox\ (Personal)/PHD\ Dropbox/1\ MODELLING/R/AppropriatenessDorothee/Appropriateness/plots/","techapp.score - ",casename,", ",techname,".pdf"),width=7,height=9)
