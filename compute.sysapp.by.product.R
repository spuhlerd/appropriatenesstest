...
#calculating the system technology appropriatness score (summarizes all technology appropriatnes scores (by product) into one score)  
    ...
    systechapp.score=(prod(systechapp.score2))^(1/l.systech)

    sysapp.score[[j]]=sysattrapp.score*systechapp.score   #combining system technology appropriatness score and system 
                                                            #attribute appropriatness score inro one score by product
    }
#creating a pdf plot 
    pdf(file=paste("C:/Users/Joel/Desktop/Joel model/Plots/","System appropriatnes score (by prod.)  ",cases[[g]],".pdf"))
